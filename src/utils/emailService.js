...
exports.sendVerificationEmail = async (toEmail, verificationLink, userName) => {
    try {
        const mailOptions = {
            ...
            to: toEmail,
            subject: 'Verify Your DIGIHUB AUST Account',
            html: `
                <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px;">
                    ...
                    <p>Thank you for creating an account with DIGIHUB AUST. To activate your account and get started, please verify your email address by clicking the button below:</p>
...
exports.sendSetPasswordEmail = async (toEmail, setPasswordLink, userName) => {
    try {
        const mailOptions = {
            from: process.env.EMAIL_FROM || '"DIGIHUB AUST Support" <support@yourdomain.com>',
            to: toEmail,
            subject: 'Complete Your DIGIHUB AUST Account Setup',
            html: `
                <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px;">
                    <div style="text-align: center; margin-bottom: 20px;">
                        <img src="https://example.com/your-logo.png" alt="DIGIHUB AUST Logo" style="max-width: 150px; height: auto;">
                    ...
                    <p>Hello <strong>${userName}</strong>,</p>
                    <p>Thank you for submitting your project quote with DIGIHUB AUST. We've created an account for you. To complete your account setup and get started, please click the link below to set your password:</p>
                    <p style="text-align: center; margin: 30px 0;">
...
exports.sendPartnerSetPasswordEmail = async (toEmail, setPasswordLink, partnerName) => {
    try {
        const mailOptions = {
            from: process.env.EMAIL_FROM || '"DIGIHUB AUST Support" <support@yourdomain.com>',
            to: toEmail,
            subject: 'Welcome to DIGIHUB AUST! Set Up Your Partner Account',
            html: `
                <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px;">
                    <div style="text-align: center; margin-bottom: 20px;">
                        <img src="https://example.com/your-logo.png" alt="DIGIHUB AUST Logo" style="max-width: 150px; height: auto;">
                    ...
                    <p>A DIGIHUB AUST administrator has created a partner account for you. To activate your dashboard and begin accepting projects, please click the link below to set your password:</p>
                    <p style="text-align: center; margin: 30px 0;">
...
exports.sendProjectOfferToClient = async (toEmail, clientName, projectName, offerPrice, offerLink, notes = '') => {
    try {
        const mailOptions = {
            from: process.env.EMAIL_FROM || '"DIGIHUB AUST Support" <support@yourdomain.com>',
            to: toEmail,
            subject: `Your Project Offer from DIGIHUB AUST: ${projectName}`,
            html: `
                <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px;">
                    <div style="text-align: center; margin-bottom: 20px;">
                        <img src="https://example.com/your-logo.png" alt="DIGIHUB AUST Logo" style="max-width: 150px; height: auto;">
        ...
        const mailOptions = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px;">
                    ...
                    <p>Our team is excited to begin working with you. You can now log in to your DIGIHUB AUST Client Dashboard to track progress, communicate with your assigned partner, and manage your project milestones.</p>
                    <p style="text-align: center; margin: 30px 0;">
...
exports.sendProjectRejectedNotification = async (toEmail, clientName, projectName) => {
    try {
        const mailOptions = {
            from: process.env.EMAIL_FROM || '"DIGIHUB AUST Support" <support@yourdomain.com>',
            to: toEmail,
            subject: `Regarding Your Project Offer for "${projectName}" on DIGIHUB AUST`,
            html: `
                <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px;">
                    <div style="text-align: center; margin-bottom: 20px;">
                        <img src="https://example.com/your-logo.png" alt="DIGIHUB AUST Logo" style="max-width: 150px; height: auto;">
                    ...
                    <p>We appreciate your interest in DIGIHUB AUST.</p>
                    <div style="margin-top: 30px; border-top: 1px solid #eee; padding-top: 20px; text-align: center; font-size: 0.9em; color: #777;">
                        <p>&copy; ${new Date().getFullYear()} DIGIHUB AUST. All rights reserved.</p>
                    </div>
                </div>
